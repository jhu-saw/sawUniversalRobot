                ...
                case 'M':   // position move Cartesian
                    ...
                    if (mask.Any()) {
                        if (!m_setpoint_cp.Valid()) {
                            ...
                            cartposSet.GetGoal(cpGoal);
                            posGoal = cpGoal.Translation();
                            rotGoal = cpGoal.Rotation();
                            if (!mask[0])
